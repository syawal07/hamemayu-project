...
export default function DashboardOverview() {
  ...
  return (
    <div className="max-w-5xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      {/* Header Dashboard */}
      <div className="mb-10 bg-white/40 dark:bg-brutal-dark/40 backdrop-blur-2xl border border-white/60 dark:border-slate-700/50 p-8 rounded-3xl shadow-[0_8px_32px_rgba(15,28,53,0.04)]">
        <h1 className="text-3xl md:text-5xl font-serif font-bold text-slate-900 dark:text-white uppercase tracking-tight mb-3">
          Selamat Datang, <br/>
          <span className="text-green-700 dark:text-yellow-400 drop-shadow-sm">{user?.name || 'Explorer'}</span>
        </h1>
        <div className="inline-flex items-center gap-2 bg-green-50/80 dark:bg-green-900/20 border border-green-200 dark:border-green-800/50 px-4 py-2 rounded-xl backdrop-blur-md">
          <span className="relative flex h-2.5 w-2.5">
            <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-green-400 opacity-75"></span>
            <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-green-500"></span>
          </span>
          <p className="font-mono text-slate-700 dark:text-slate-300 text-xs font-bold tracking-widest uppercase">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        ...
        <div className="bg-linear-to-br from-green-700 to-green-900 dark:from-brutal-dark dark:to-slate-900 border border-white/20 dark:border-slate-700/50 p-8 rounded-3xl shadow-[0_8px_32px_rgba(22,101,52,0.15)] relative overflow-hidden group">
        ...
        <div className="bg-white/60 dark:bg-brutal-dark/60 backdrop-blur-2xl border border-white/60 dark:border-slate-700/50 p-8 rounded-3xl shadow-[0_8px_32px_rgba(15,28,53,0.04)] relative overflow-hidden group hover:shadow-[0_16px_48px_rgba(15,28,53,0.08)] transition-all duration-500">
        ...
        {/* Card 3: Wishlist */}
        <div className="bg-white/40 dark:bg-slate-800/30 backdrop-blur-md border border-white/50 dark:border-slate-700/40 p-8 rounded-3xl shadow-[0_4px_24px_rgba(15,28,53,0.03)] relative overflow-hidden group hover:shadow-[0_12px_36px_rgba(15,28,53,0.06)] transition-all duration-500">
